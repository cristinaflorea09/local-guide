    ...
    var body: some View {
        Group {
            ...
            if appState.session.firebaseUser != nil
                ...
                AuthFlowView(startAt: appState.session.startAuthAtLoginNext ? .login : nil)
            }
        }
        // Apply locale changes without recreating the entire view tree.
        // Recreating the tree resets TabView selection and navigation.
